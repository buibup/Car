...
namespace Car.Data.Migrations
{
    ...
    [Migration("20190324080554_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Car.Data.EntityModels.Cooperation", b =>
                {
                    ...
                    b.Property<int?>("ProspectStatusId")
                        .HasColumnName("prospect_status_id");
                    ...
                    b.Property<int?>("VehicleAsId")
                        .HasColumnName("vehicle_as_id");

                    b.HasKey("Id")
                        .HasName("pk_cooperations");

                    b.HasIndex("ProspectStatusId")
                        .HasName("ix_cooperations_prospect_status_id");

                    b.HasIndex("SourceId")
                        .HasName("ix_cooperations_source_id");

                    b.HasIndex("VehicleAsId")
                        .HasName("ix_cooperations_vehicle_as_id");
            ...
            modelBuilder.Entity("Car.Data.EntityModels.Government", b =>
                {
                    ...
                    b.HasIndex("ProspectStatusId")
                        .HasName("ix_governments_prospect_status_id");

                    b.HasIndex("SourceId")
                        .HasName("ix_governments_source_id");

                    b.HasIndex("VehicleAsId")
                        .HasName("ix_governments_vehicle_as_id");
            ...
            modelBuilder.Entity("Car.Data.EntityModels.Personal", b =>
                {
                    ...
                    b.HasIndex("ProspectStatusId")
                        .HasName("ix_personals_prospect_status_id");
                    ...
                    b.HasIndex("VehicleAsId")
                        .HasName("ix_personals_vehicle_as_id");
            ...
            modelBuilder.Entity("Car.Data.EntityModels.Cooperation", b =>
                {
                    b.HasOne("Car.Data.EntityModels.Prospect", "ProspectStatus")
                        .WithMany()
                        .HasForeignKey("ProspectStatusId")
                        .HasConstraintName("fk_cooperations_prospect_prospect_status_id");
                    ...
                    b.HasOne("Car.Data.EntityModels.Vehicle", "VehicleAs")
                        .WithMany()
                        .HasForeignKey("VehicleAsId")
                        .HasConstraintName("fk_cooperations_vehicle_vehicle_as_id");
                });
            ...
            modelBuilder.Entity("Car.Data.EntityModels.Government", b =>
                {
                    b.HasOne("Car.Data.EntityModels.Prospect", "ProspectStatus")
                        .WithMany()
                        .HasForeignKey("ProspectStatusId")
                        .HasConstraintName("fk_governments_prospect_prospect_status_id");
                    ...
                    b.HasOne("Car.Data.EntityModels.Vehicle", "VehicleAs")
                        .WithMany()
                        .HasForeignKey("VehicleAsId")
                        .HasConstraintName("fk_governments_vehicle_vehicle_as_id");
                });
            ...
            modelBuilder.Entity("Car.Data.EntityModels.Personal", b =>
                {
                    ...
                    b.HasOne("Car.Data.EntityModels.Prospect", "ProspectStatus")
                        .WithMany()
                        .HasForeignKey("ProspectStatusId")
                        .HasConstraintName("fk_personals_prospect_prospect_status_id");
                    ...
                    b.HasOne("Car.Data.EntityModels.Vehicle", "VehicleAs")
                        .WithMany()
                        .HasForeignKey("VehicleAsId")
                        .HasConstraintName("fk_personals_vehicle_vehicle_as_id");
                });
